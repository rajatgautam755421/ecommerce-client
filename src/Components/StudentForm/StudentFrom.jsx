...
const StudentFrom = () => {
  ...
  return (
    <>
      {rollError !== "" && (
        <Snackbar open={render} autoHideDuration={2000} onClose={handleClose}>
      ...
      {feeError && (
        <Snackbar open={feeError} autoHideDuration={2000} onClose={handleClose}>
          <Alert onClose={handleClose} severity="error" sx={{ width: "100%" }}>
      ...
      {empty && (
        <Snackbar open={empty} autoHideDuration={2000} onClose={handleClose}>
          <Alert onClose={handleClose} severity="error" sx={{ width: "100%" }}>
            Fields Are empty
          </Alert>
        </Snackbar>
